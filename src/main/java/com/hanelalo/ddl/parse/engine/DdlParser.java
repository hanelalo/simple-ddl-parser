...
public class DdlParser extends Parser {
	...
	public static final int
		...
		RULE_columnAttrOption = 18, RULE_uniqueColumnAttrOption = 19, RULE_primaryKeyOption = 20, 
		RULE_autoincrementOption = 21, RULE_nullOption = 22, RULE_defaultOption = 23, 
		RULE_defaultValue = 24, RULE_indexOption = 25, RULE_indexName = 26, RULE_indexColumns = 27, 
		RULE_primaryKey = 28, RULE_primaryKeyName = 29, RULE_primaryKeyColumn = 30, 
		RULE_uniqueKey = 31, RULE_uniqueKeyName = 32, RULE_uniqueKeyColumn = 33, 
		RULE_tableOptions = 34, RULE_tableOption = 35, RULE_tableComment = 36, 
		RULE_tabelCommentContent = 37, RULE_autoIncrementTableOption = 38, RULE_id = 39;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"commentContent", "columnAttrOptions", "columnAttrOption", "uniqueColumnAttrOption", 
			"primaryKeyOption", "autoincrementOption", "nullOption", "defaultOption", 
			"defaultValue", "indexOption", "indexName", "indexColumns", "primaryKey", 
			"primaryKeyName", "primaryKeyColumn", "uniqueKey", "uniqueKeyName", "uniqueKeyColumn", 
	...
	public final UniqueColumnAttrOptionContext uniqueColumnAttrOption() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_uniqueColumnAttrOption);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(180);
	...
	public final AutoincrementOptionContext autoincrementOption() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_autoincrementOption);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(185);
	...
	public final DefaultOptionContext defaultOption() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_defaultOption);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(192);
	...
	public final IndexOptionContext indexOption() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_indexOption);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final IndexNameContext indexName() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_indexName);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(216);
	...
	public final IndexColumnsContext indexColumns() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_indexColumns);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PrimaryKeyNameContext primaryKeyName() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_primaryKeyName);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(235);
	...
	public final PrimaryKeyColumnContext primaryKeyColumn() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_primaryKeyColumn);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final UniqueKeyContext uniqueKey() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_uniqueKey);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final UniqueKeyNameContext uniqueKeyName() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_uniqueKeyName);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(254);
	...
	public final UniqueKeyColumnContext uniqueKeyColumn() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_uniqueKeyColumn);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final TableOptionContext tableOption() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_tableOption);
		try {
			setState(272);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final TableCommentContext tableComment() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_tableComment);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final TabelCommentContentContext tabelCommentContent() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_tabelCommentContent);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(280);
	...
	public final AutoIncrementTableOptionContext autoIncrementTableOption() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_autoIncrementTableOption);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
