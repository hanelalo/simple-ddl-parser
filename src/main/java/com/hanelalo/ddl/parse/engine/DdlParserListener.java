...
public interface DdlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DdlParser#uniqueColumnAttrOption}.
	 * @param ctx the parse tree
	 */
	void enterUniqueColumnAttrOption(DdlParser.UniqueColumnAttrOptionContext ctx);
	/**
	 * Exit a parse tree produced by {@link DdlParser#uniqueColumnAttrOption}.
	 * @param ctx the parse tree
	 */
	void exitUniqueColumnAttrOption(DdlParser.UniqueColumnAttrOptionContext ctx);
	/**
